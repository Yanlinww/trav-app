...
$types = 'sssssiiii';
$params = [$search, $searchLike, $searchLike, $transport, $transport, $durationMin, $durationMin, $durationMax, $durationMax];
foreach ($tags as $tag) {
...
$sql .= "
  ...
  ORDER BY i.Copy_Count DESC, i.Start_Date DESC, i.Itinerary_ID DESC
  LIMIT ?
";
$types .= 'i';
$params[] = $limit;
