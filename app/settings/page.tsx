...
export default function SettingsPage() {
  ...
  const continueNavigation = (destination: PendingNavigation) => {
  ...
  const handleSaveAndContinue = async () => {
    ...
    if (await saveProfile()) continueNavigation(destination);
  };
