            ...
            <div className="relative flex items-center gap-4">
              ...
              {userMenuOpen && (
                <div className="absolute top-14 right-0 w-48 bg-white border border-neutral-100 rounded-sm shadow-xl py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  <Link to="/profile">
                    <div className="flex items-center gap-3 px-4 py-2.5 text-sm font-bold text-neutral-600 hover:bg-neutral-50 hover:text-neutral-900 cursor-pointer transition-colors tracking-widest">
